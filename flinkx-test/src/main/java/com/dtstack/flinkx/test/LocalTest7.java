...
public class LocalTest7 {
    ...
    public static Logger LOG = LoggerFactory.getLogger(LocalTest7.class);
...
//        conf.setString("metrics.reporter.promgateway.deleteOnShutdown","true");
        ...
        String jobPath = "D:\\spt\\AI-whale\\b\\pipeline\\pipeline-agents\\flink-agent\\job\\oracle10_to_stream.json";
        JobExecutionResult result = LocalTest7.runJob(new File(jobPath), confProperties, null);
