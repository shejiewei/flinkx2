...
//        String jobPath = "C:\\Users\\xin\\Desktop\\binlog_to_stream.json";
        String jobPath = "D:\\spt\\AI-whale\\b\\pipeline\\pipeline-agents\\flink-agent\\job\\wal_read.json";
        
        String savePointPath = "";
        JobExecutionResult result = LocalTest2.runJob(new File(jobPath), confProperties, savePointPath);
