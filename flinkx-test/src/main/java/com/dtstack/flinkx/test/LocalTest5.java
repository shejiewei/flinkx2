...
public class LocalTest5 {
    ...
    public static Logger LOG = LoggerFactory.getLogger(LocalTest5.class);
...
//        conf.setString("metrics.reporter.promgateway.deleteOnShutdown","true");
        ...
        String jobPath = "D:\\spt\\AI-whale\\b\\pipeline\\pipeline-agents\\flink-agent\\job\\oracle_to_oracle.json";
       // String jobPath = "D:\\spt\\AI-whale\\b\\pipeline\\pipeline-agents\\flink-agent\\job\\binlog_to_kafka.json";
        JobExecutionResult result = LocalTest5.runJob(new File(jobPath), confProperties, null);
