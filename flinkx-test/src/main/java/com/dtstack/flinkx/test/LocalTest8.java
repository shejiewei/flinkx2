...
public class LocalTest8 {
    ...
    public static Logger LOG = LoggerFactory.getLogger(LocalTest8.class);
...
//        conf.setString("metrics.reporter.promgateway.deleteOnShutdown","true");
        ...
        String jobPath = "D:\\spt\\AI-whale\\b\\pipeline\\flinkx2\\flinkx-test\\src\\main\\java\\com\\dtstack\\flinkx\\test\\kafka_to_oracle.json";
        JobExecutionResult result = LocalTest8.runJob(new File(jobPath), confProperties, null);
