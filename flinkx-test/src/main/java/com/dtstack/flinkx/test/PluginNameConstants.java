...
public class PluginNameConstants {
    public static final String PG9WAL_READER = "pg9walreader";
    public static final String ORACLE_LOGMINER_WRITER = "logminerwriter";
    public static final String ORACLE_LOGMINER_READER = "logminerreader";
