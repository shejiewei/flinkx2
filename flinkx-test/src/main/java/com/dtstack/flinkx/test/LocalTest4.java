...
public class LocalTest4 {
    ...
    public static Logger LOG = LoggerFactory.getLogger(LocalTest4.class);
...
//        conf.setString("metrics.reporter.promgateway.deleteOnShutdown","true");
        ...
        String jobPath = "D:\\spt\\AI-whale\\b\\pipeline\\flinkx2\\flinkx-test\\src\\main\\java\\com\\dtstack\\flinkx\\test\\oracle_to_oracle.json";
        JobExecutionResult result = LocalTest4.runJob(new File(jobPath), confProperties, null);
