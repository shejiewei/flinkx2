...
import static com.dtstack.flinkx.logminer.Util.OracleConnectorSchema.SEG_OWNER_FIELD;
import static com.dtstack.flinkx.logminer.Util.OracleConnectorSchema.TABLE_NAME_FIELD;
...
public class OracleSourceConnectorUtils{
   ...
   // private final Map<String,Schema> tableSchema = new HashMap<>();
    ...
    private final Map<String, com.dtstack.flinkx.logminer.Util.models.Column> tabColsMap = new HashMap<>();
   ...
   List<String> whiteList;
    ...
    public OracleSourceConnectorUtils(Connection Conn,List<String> whiteList,List<String> blackList )throws SQLException {
        this.dbConn=Conn;
    ...
    public String getLogMinerSelectSqlDeSupportCM(){
      return this.logMinerSelectSqlDeSupportCM;
    }

    public Map<String,String> getTableColType(){
        return this.tableColType;
    }

 /*   public Struct getRowDataStruct(String tableName){
        return new Struct(tableSchema.get(tableName));
    }

    public Schema getTableRecordSchema(String tableName){
...
*/
    ...
    public void parseTableWhiteList(){

        logMinerSelectWhereStmt="(";
        List<String> tabWithSchemas = whiteList;
...
/*
    public void loadTable(String owner,String tableName,String operation) throws SQLException{
...
/*    public Map<String,LinkedHashMap<String,String>> parseSql(String owner,String tableName,String sqlRedo) throws JSQLParserException , SQLException{
...
/*
    public DataSchemaStruct createDataSchema(String owner,String tableName,String sqlRedo,String operation) throws Exception{
