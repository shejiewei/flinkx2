...
public class DMLRow{
    ...
    public DMLRow(String xid,Long scn,Long commitScn,Timestamp timestamp,String operation,String segOwner,String segName,String rowId,String sqlRedo,Timestamp commitTimeStamp,String rollback){
        this.xid = xid;
        this.scn = scn;
