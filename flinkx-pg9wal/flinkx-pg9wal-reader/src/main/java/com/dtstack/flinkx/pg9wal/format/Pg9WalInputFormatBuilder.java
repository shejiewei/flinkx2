 ...
 * @author tudou
 */
public class Pg9WalInputFormatBuilder extends BaseRichInputFormatBuilder {

    protected Pg9WalInputFormat format;

    public Pg9WalInputFormatBuilder() {
        super.format = this.format = new Pg9WalInputFormat();
    }
