...
package com.dtstack.flinkx.pg9wal.reader;

import com.dtstack.flinkx.config.DataTransferConfig;
import com.dtstack.flinkx.config.ReaderConfig;
import com.dtstack.flinkx.pg9wal.PgWalConfigKeys;
import com.dtstack.flinkx.pg9wal.format.Pg9WalInputFormatBuilder;
 ...
 * @author tudou
 */
public class Pg9walReader extends BaseDataReader {
    ...
    public Pg9walReader(DataTransferConfig config, StreamExecutionEnvironment env) {
        super(config, env);
    ...
    public DataStream<Row> readData() {
        Pg9WalInputFormatBuilder builder = new Pg9WalInputFormatBuilder();
        ...
        return createInput(builder.finish(), "pg9walreader");
    }
}
