...
package com.dtstack.flinkx.pg9wal.format;

import com.dtstack.flinkx.inputformat.BaseRichInputFormat;
import com.dtstack.flinkx.pg9wal.Pg9RelicationSlot;
import com.dtstack.flinkx.pg9wal.PgWalUtil;
import com.dtstack.flinkx.pg9wal.listener.Pg9WalListener;
 ...
 * @author tudou
 */
public class Pg9WalInputFormat extends BaseRichInputFormat {
    ...
    protected void openInternal(InputSplit inputSplit) throws IOException {
        ...
        try {
            ...
            reconn = PgWalUtil.getSimpleConnection(url, username, password);
            if(StringUtils.isBlank(slotName)){
                slotName = PgWalUtil.SLOT_PRE +databaseName+ jobId;
            }
            Pg9RelicationSlot availableSlot = PgWalUtil.checkPostgres(reconn, allowCreateSlot, slotName, tableList);
            ...
            executor.submit(new Pg9WalListener(this));
            running = true;
        }catch (Exception e){
